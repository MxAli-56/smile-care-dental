...
const CLINIC_DATA = {
                                                                        ...
                                                                                    description: "Get rid of stubborn stains and plaque for a healthy, shiny smile with our advanced ultrasonic scaling technology.",
                                                                        ...
                                                                                    description: "Safe, painless removal of impacted wisdom teeth by our expert oral surgeon using minimally invasive techniques.",
                                                                        ...
                                                                                    description: "Comprehensive orthodontic treatment with flexible installment plans for perfectly aligned teeth.",
                                                                        ...
                                                                                    description: "Professional teeth whitening treatments that deliver dramatic results in just one session.",
                                                                        ...
                                                                                    description: "Save your natural teeth with our pain-free root canal treatments using rotary technology.",
                                                                                    priceRange: "PKR 7,000 - 12,000",
                                                                                    icon: "droplet",
                                                                                    imageUrl: "http://static.photos/medical/640x360/303",
                                                                        ...
                                                                            ],
                                                                            amenities: [
                                                                                { title: "24/7 Generator Backup", detail: "Uninterrupted procedures, no load-shedding impact", icon: "zap" },
                                                                                { title: "Valet Parking Service", detail: "Professional staff to handle your vehicle", icon: "car" },
                                                                                { title: "RO Filtered Water", detail: "Pure drinking water for all patients", icon: "droplet" },
                                                                                { title: "Separate Prayer Area", detail: "Dedicated space for Salah", icon: "church" },
                                                                                { title: "Kid-Friendly Zone", detail: "Games and toys for our little champions", icon: "gamepad-2" },
                                                                                { title: "Digital X-Ray System", detail: "Low radiation, high precision imaging", icon: "scan" },
                                                                                { title: "Comfortable Lounge", detail: "Relaxing waiting area with refreshments", icon: "coffee" },
                                                                                { title: "Free Wi-Fi", detail: "High-speed internet for all visitors", icon: "wifi" }
                                                                            ],
                                                                            landmarks: [
                                                                                "Near Lucky One Mall",
                                                                        ...
                                                                                serviceCard.className = 'bg-white rounded-3xl shadow-card card-hover overflow-hidden border border-gray-100';
                                                                        ...
                                                                                    <div class="relative h-64 overflow-hidden">
                                                                                            <img src="${service.imageUrl}" alt="${service.title}"                    
                                                                                ...
                                                                                 loading="lazy">
                                                                                            <div
                                                                                class="absolute top-4 right-4 bg-white/90 backdrop-blur-sm w-12 h-12 rounded-xl flex items-center justify-center shadow-sm">
                                                                        ...
                                                                                    <div class="p-8">
                                                                            ...
                                                                                            <div class="mb-6">
                                                                                ...
                                                                                                        <span
                                                                                    class="inline-block bg-primary/10 text-primary text-xs font-semibold px-3 py-1.5 rounded-full mr-2 mb-2">
                                                                                                                ${feature}
                                                                                                            </span>
                                                                                                    `).join('') : ''}
                                                                                                </div>
                                                                            ...
                                                                                            <div class="flex items-center justify-between pt-6 border-t border-gray-100">
                                                                                                    <div>
                                                                                                            <p class="text-xs font-bold text-light uppercase tracking-wider mb-1">Starts From
                                                                                    </p>
                                                                                                            <p class="font-display font-bold text-2xl text-primary">
                                                                                        ${service.priceRange.split('-')[0].trim()}</p>
                                                                                                        </div>
                                                                                                    <button
                                                                        ...
                                                                                doctorCard.className = 'bg-white rounded-3xl shadow-card card-hover overflow-hidden border border-gray-100';
                                                                        ...
                                                                                amenityItem.className = 'flex items-start space-x-5 p-6 rounded-2xl bg-white shadow-card card-hover border border-gray-100';
                                                                        ...
                                                                            } else {
                                                                                const bubble = document.getElementById('flexibot-bubble') || document.querySelector('[class*="flexibot"]');
                                                                                if (bubble) {
                                                                                    bubble.click();
                                                                                } else {
                                                                                    alert('AI Assistant is currently unavailable. Please call us directly at 021-34XXXXXX');
                                                                                }
                                                                            }
                                                                        }
